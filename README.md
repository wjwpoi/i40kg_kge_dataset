...
This dataset is intended to support research in knowledge graph completion, link prediction, and related embedding tasks, providing a realistic use case from the Industry 4.0 environment.

For detailed information regarding dataset construction, statistics, and experimental results, please refer to our paper. If you use this dataset in your work, we kindly request that you cite both the original data source (Yahya et al., 2024) and our paper (Wu et al., 2025).

**If you find this dataset helpful for your research, please consider giving it a star ⭐️ on GitHub!**
